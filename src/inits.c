...
/*   Updated: 2025/01/13 10:32:53 by agarbacz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    init_app(t_frac_data *fractal_data)
{
    ...
    fractal_data->mlx_data->window_ptr = mlx_new_window(fractal_data->mlx_data->mlx_ptr, SCREEN_WIDTH, SCREEN_HEIGHT, "fract-ol");
}
